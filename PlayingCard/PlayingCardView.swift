...
extension PlayingCardView {
	private struct SizeRatio {
		static let cornerFontSizeToBundsHeight: CGFloat = 0.085
		static let cornerRadiusToBundsHeight: CGFloat = 0.06
		static let cornerOffsetToCornerRadius: CGFloat = 0.33
		static let faceCardImageSizeToBoundsSize: CGFloat = 0.75
	}

	private var cornerRadius: CGFloat {
		return bounds.size.height * SizeRatio.cornerRadiusToBundsHeight
	}
	...
	private var cornerFontSize: CGFloat {
		return bounds.size.height * SizeRatio.cornerFontSizeToBundsHeight
	}
